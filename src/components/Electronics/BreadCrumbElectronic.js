...
const BreadCrumbElectronic = ({ productId}) => {
  const [clickedItems, setClickedItems] = useState([]);

  const selectedProduct = earphoneData.find((item) => item.id === productId);
  ...
  return (
      ...
      <Breadcrumb.Item linkAs={Link} linkProps={{ to: '/consumerelectronics' }}>Headphones & Earphones</Breadcrumb.Item>
...
export default BreadCrumbElectronic;
