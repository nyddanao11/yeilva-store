...
const BreadCrumbCooking = ({ productId}) => {
  const [clickedItems, setClickedItems] = useState([]);

  const selectedProduct = cooking.find((item) => item.id === productId);
  ...
  return (
      ...
      <Breadcrumb.Item linkAs={Link} linkProps={{ to: '/groceryitemspage' }}>Cooking Items</Breadcrumb.Item>
...
export default BreadCrumbCooking;
