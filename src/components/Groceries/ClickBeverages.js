...
import '../LoanForm.css';
import BreadCrumbBeverages from'./BreadCrumbBeverages';
import YouMayLike from'../YouMayLike';
import { FaShippingFast} from 'react-icons/fa'; // Import the icons you want to use

export default function ClickBeverages ({ addToCart, isLoggedIn }) {
  const { id } = useParams();
  ...
  return (
    ...
    <Container className="mt-3">
      <Row className="justify-content-center">
        <BreadCrumbBeverages productId={product.id} />
