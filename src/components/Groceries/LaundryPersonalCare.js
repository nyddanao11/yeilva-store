...
const LaundryPersonalCare= ({ cartItems, products, currentPage, setCurrentPage}) => {
  ...
  const visibleProducts = laundry.filter((product) => product.page === currentPage);

const totalPages = Math.max(...laundry.map((product) => product.page));
