...
const HighConversionProductPage = ({ productId, storedProducts, userEmail, handleCheckoutClick, discountedPriceFormatted }) => {
...
export default HighConversionProductPage;