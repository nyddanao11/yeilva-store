...
const HighConversionProductBest = ({ productId, bestSellingProducts, userEmail, handleCheckoutClick, discountedPriceFormatted }) => {
...
export default HighConversionProductBest;