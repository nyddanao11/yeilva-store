...
const HighConversionProductDeals = ({ productId, allDealsProduct, userEmail, handleCheckoutClick, discountedPriceFormatted }) => {
...
export default HighConversionProductDeals;