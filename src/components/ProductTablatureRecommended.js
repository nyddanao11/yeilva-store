...
const HighConversionProductRecommended = ({ productId,recommendedProducts, userEmail, handleCheckoutClick, discountedPriceFormatted }) => {
...
export default HighConversionProductRecommended;