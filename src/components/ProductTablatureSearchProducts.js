...
const HighConversionProductSearch = ({ productId, searchProducts, userEmail, handleCheckoutClick, discountedPriceFormatted }) => {
...
export default HighConversionProductSearch;