...
const TabbedComponentYouMayLike = ({productId}) => {
          ...
          <Col>
            <Tab.Content>
              ...
              <Tab.Pane eventKey="reviews">
                <Reviews selectedProduct={youMayLikeData.find(product => product.id === productId)} />
              </Tab.Pane>
...
export default TabbedComponentYouMayLike;
