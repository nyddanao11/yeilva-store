...
const HighConversionProductLike = ({ productId, youMayLikeProducts, userEmail, handleCheckoutClick, discountedPriceFormatted }) => {
...
export default HighConversionProductLike;