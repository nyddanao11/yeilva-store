  export const bondpaper = [
    ...
    { id: 4, name: 'short', price: 8, weight:12, url:`${process.env.PUBLIC_URL}/schoolsupplies/notebook01.png`, category: 'School Supplies', description:'Flavored Barbecue Corn Chips 200g' , stock:10, page:1, 
     ...
     { id: 5, name: 'short', price: 5, weight:12, url:`${process.env.PUBLIC_URL}/schoolsupplies/paper01.png`, category: 'School Supplies', description:'Flavored Barbecue Corn Chips 200g ', stock:10, page:1, 
        thumbnails:
      [`${process.env.PUBLIC_URL}/schoolsupplies/paper01.png`,
        `${process.env.PUBLIC_URL}/schoolsupplies/paper01.png`,
      ],},
    { id: 6, name: 'Long', price: 7, weight:12, url:`${process.env.PUBLIC_URL}/schoolsupplies/eraser01.png`, category: 'School Supplies', description:'Flavored Barbecue Corn Chips 200g', stock:0, page:2, 
     thumbnails:
      [`${process.env.PUBLIC_URL}/schoolsupplies/eraser01.png`,
        `${process.env.PUBLIC_URL}/schoolsupplies/eraser01.png`,
      ],},
     { id:7, name: 'A4', price: 6, weight:12, url:`${process.env.PUBLIC_URL}/schoolsupplies/paper01.png`, category: 'School Supplies', description:'Flavored Barbecue Corn Chips 200g', stock:0, page:2, 
        thumbnails:
      [`${process.env.PUBLIC_URL}/schoolsupplies/paper01.png`,
        `${process.env.PUBLIC_URL}/schoolsupplies/bpaper01.png`,
      ],},
    { id: 8, name: 'short', price: 8, weight:12, url:`${process.env.PUBLIC_URL}/schoolsupplies/paper01.png`, category: 'School Supplies', description:'Flavored Barbecue Corn Chips 200g' , stock:10, page:2, 
        thumbnails:
      [`${process.env.PUBLIC_URL}/schoolsupplies/paper01.png`,
        `${process.env.PUBLIC_URL}/schoolsupplies/paper01.png`,
      ],},
