...
import HighConversionProductFeatured from'../components/ProductTablatureFeatured';
    ...
    <Row className="justify-content-center g-4 lg-g-5 product-main-row align-items-start py-4">
        ...
        <Row className="my-5">
          <Col xs={12}>
            ...
            {product && <HighConversionProductFeatured  productId={product.id} featuredProducts={featuredProducts} handleCheckoutClick={handleCheckoutClick} discountedPriceFormatted={finalPriceFormatted}/>}
          </Col>
        </Row>
